...
const ALL_PAGES = [
  { id: 'hub', title: 'Hub Dashboard', icon: '🏠', to: '/', status: 'live', grad: 'linear-gradient(135deg,#4DB6AC,#26A69A)', tags: ["Today's stats", 'Activity heatmap', 'All feature links'], desc: 'Central dashboard linking all features. Today\'s stats, activity heatmap, and quick navigation.' },
  ...
  if (loading) return (
    <div className="alu-s" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ color: 'var(--muted-fg)', fontWeight: 600 }}>Loading your hub...</p>
      </div>
    </div>
  );

  return (
    <div className="alu-s" data-testid="hub-page">
